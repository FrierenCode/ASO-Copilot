...
export default function SignupPage() {
  ...
  const handleSubmit = (event: FormEvent) => {
    ...
    setMessage(`Signup flow is coming soon. (${email})`)
  }
  ...
  return (
    <main style={{ fontFamily: 'sans-serif', color: '#111827' }}>
      ...
      <section style={{ maxWidth: 440, margin: '56px auto 72px', padding: '0 16px' }}>
        <h1 style={{ marginBottom: 8, fontSize: 30 }}>Signup</h1>
        <p style={{ marginBottom: 20, color: '#6b7280', lineHeight: 1.6 }}>
          Create your account with a magic link. Auth backend integration is in progress.
        </p>
